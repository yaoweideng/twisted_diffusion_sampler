...
python seq_reweight_pf.py \
    ...
    inference.motif_scaffolding.reweight_t=$NUM_STEPS_SEQ \
    inference.motif_scaffolding.omega_geom=$OMEGA_GEOM \
    inference.motif_scaffolding.omega_seq=$OMEGA_SEQ \
